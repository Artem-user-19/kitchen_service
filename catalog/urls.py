...
from catalog.views import DishDetailView, IndexView, DetailsView, BeverageListView, CreateDishView, \
    DeleteDishView, UserDishesView, UpdateDishView, GuestPageView
...
urlpatterns = [
    ...
    path('update_dish/<int:dish_id>/', UpdateDishView.as_view(), name='update_dish'),
